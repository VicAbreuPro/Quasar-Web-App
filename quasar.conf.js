  ...
  return {
    ...
    build: {
      ...
      env:{
        ...
        API_VNA_VTKN:'https://apivna20.azurewebsites.net/Internal/UserType/',
        API_VNA_GCLI:'https://apivna20.azurewebsites.net/Client/ClientList',
        API_VNA_PCLI:'https://apivna20.azurewebsites.net/Client/AddClient',
        API_VNA_UCLI:'https://apivna20.azurewebsites.net/Client/UpdateClient',
        API_VNA_TCLI:'https://apivna20.azurewebsites.net/Client/TopClientLocation',
        API_VNA_GPRO:'https://apivna20.azurewebsites.net/Product/ProductList',
        API_VNA_PPRO:'https://apivna20.azurewebsites.net/Product/AddProduct',
        API_VNA_UPRO:'https://apivna20.azurewebsites.net/Product/UpdateProduct',
        API_VNA_TPRO:'https://apivna20.azurewebsites.net/Product/TopStockProduct',
